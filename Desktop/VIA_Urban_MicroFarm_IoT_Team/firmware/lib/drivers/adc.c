...
#include <stdbool.h>
#include <stdint.h>
ADC_Error_t adc_create(ADC_Channel_t channel, ADC_Reference_t reference) { (void)channel; (void)reference; return ADC_OK; }
uint16_t adc_measure(ADC_Channel_t channel) { (void)channel; return 0; }
#endif
